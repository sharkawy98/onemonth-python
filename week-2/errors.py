#######
# Your task is to do some debugging and fix my code. 
# Give it a try, it's not too tough—everything you need to know to complete this project
...
def sing(bottles):
    for number in  range(99,-1,-1): #reversed(range(bottles+1)):
        if number > 0:
            print_verse(number)
        else:
            print_last_verse()
